  ...
  return (
    <div className='navbar navbar-dark bg-dark'>
      <Link className='navbar-brand' to='/'>
        <img src="https://seeklogo.com/images/D/dragon-logo-34D6842F63-seeklogo.com.png" alt="Logo" width="30" height="30" className="d-inline-block align-text-top" /> 
        {
          user ? 'Usuario: ' + user.email : 'Khaleesi'
        }
      </Link>
